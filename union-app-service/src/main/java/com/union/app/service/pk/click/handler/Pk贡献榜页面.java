...
@Service
public class Pk贡献榜页面 implements ClickHandler {
    ...
    @PostConstruct
    void init(){
        clickService.registeHandler(ClickItem.PK贡献榜,this);
    }
    ...
    public PageAction handle(String userId, String id) {
        ...
        return PageAction.页面跳转("/pages/pk/pkRankList/pkRankList?pkId=" + id,false);
