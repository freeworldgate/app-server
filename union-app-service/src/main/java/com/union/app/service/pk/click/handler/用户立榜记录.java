...
@Service
public class 用户立榜记录 implements ClickHandler {
    ...
    @PostConstruct
    void init(){
        clickService.registeHandler(ClickItem.立榜记录,this);
    }
    ...
    public PageAction handle(String userId, String id) {
        ...
        return PageAction.页面跳转("/pages/pk/userCreatePks/userCreatePks",true);
